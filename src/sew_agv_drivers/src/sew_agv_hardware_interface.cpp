...
namespace sew_agv_drivers
{
  ...
  AgvHardwareInterface::~AgvHardwareInterface() {
    //Destruct Instances if controller manager is shut down via ctrl + C, because on_deactivate isnt called then
  ...
  hardware_interface::return_type AgvHardwareInterface::write(const rclcpp::Time& time, const rclcpp::Duration& period)
  {
